...
#define DEBUG_TYPE "sim-isellower"
                                    ...
                                    SmallVectorImpl<SDValue> &InVals) const
{
  ...
  CCState CCInfo(CallConv, isVarArg, DAG.getMachineFunction(), ArgLocs,
                 *DAG.getContext());
  CCInfo.AnalyzeFormalArguments(Ins, SIM_CCallingConv);
                                ...
                                LLVMContext &Context) const
{
  ...
  return CCInfo.CheckReturn(Outs, SIM_CRetConv);
}
...
SIMTargetLowering::LowerCallResult(SDValue Chain, SDValue InFlag,
  ...
  CCState CCInfo(CallConv, isVarArg, DAG.getMachineFunction(), RVLocs,
                 *DAG.getContext());
  CCInfo.AnalyzeCallResult(Ins, SIM_CRetConv);
...
SIMTargetLowering::LowerReturn(SDValue Chain,
  ...
  CCInfo.AnalyzeReturn(Outs, SIM_CRetConv);
